    ...
    'menu' => [
        ...
        [
            ...
            'submenu' => [
                [
                    'text' => 'Numerações',
                    'url'  => '/admin/numeracoes',
                ],
                [
                    'text' => 'Locais de origem',
                    'url'  => '/admin/origens',
                ],
                [
                    'text' => 'Locais de destino',
                    'url'  => '/admin/destinos',
                ],
                [
                    'text'    => 'Remetentes',
                    'url'     => '/admin/remetentes',
                ],
                [
                    'text' => 'Embalagens',
                    'url'  => '/admin/embalagens',
                ],
                [
                    'text' => 'Modais',
                    'url'  => '/admin/modais',
        ...
        ['header' => 'Registro de movimentação'],
        [
            'text'       => 'Materiais',
            'icon_color' => 'red',
            'url'  => '/admin/materiais',
