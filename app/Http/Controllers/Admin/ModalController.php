...
use App\Http\Requests\StoreUpdateModalFormRequest;
...
class ModalController extends Controller
{
    ...
    public function __construct(ModalRepositoryInterface $repository, Request $request) 
    {
    ...
    public function index()
    {
        ...
        //chama a view admin/modais/index.blade.php para listagem dos dados
     ...
     * @return \Illuminate\Http\Response
     */
    public function store(StoreUpdateModalFormRequest $request)
    {
    ...
    public function show($id)
    {
        ...
        //chama a view admin/modais/show.blade.php e passa os dados na variável $data
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(StoreUpdateModalFormRequest $request, $id)
    {
         //atualia os dados de um registro específico
        $this->repository->update($id, $request->all());
        
        //redireciona para a view admin/modais/index.blade.php
    ...
    {
        //verifica se a conta foi deletada com sucesso e redireciona para a view admin/modais/index.blade.php,
    ...
    public function search(Request $request) 
    {
        ...
        //chama a view admin/modais/index.blade.php retornado os filtros e os dados encontrados
