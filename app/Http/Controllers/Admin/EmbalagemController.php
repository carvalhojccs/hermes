...
use App\Http\Requests\StoreUpdateEmbalagemFormRequest;
...
class EmbalagemController extends Controller
{
    ...
    public function __construct(EmbalagemRepositoryInterface $repository, Request $request) 
    {
    ...
    public function index()
    {
        ...
        //chama a view admin/embalagens/index.blade.php para listagem dos dados
    ...
    {
        //chama a view admin/embalagens/create.blade.php com o formulário para cadastro
     ...
     * @return \Illuminate\Http\Response
     */
    public function store(StoreUpdateEmbalagemFormRequest $request)
    {
    ...
    public function show($id)
    {
        ...
        //chama a view admin/embalagens/show.blade.php e passa os dados na variável $data
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(StoreUpdateEmbalagemFormRequest $request, $id)
    {
        //atualia os dados de um registro específico
        $this->repository->update($id, $request->all());
        
        //redireciona para a view admin/embalagens/index.blade.php
    ...
    {
        //verifica se a conta foi deletada com sucesso e redireciona para a view admin/embalagens/index.blade.php,
    ...
    public function search(Request $request) 
    {
        ...
        //chama a view admin/embalagens/index.blade.php retornado os filtros e os dados encontrados
