...
class StatusController extends Controller
{
    ...
    public function __construct(StatusRepositoryInterface $repository, Request $request) 
    {
    ...
    public function index()
    {
        ...
        //chama a view admin/status/index.blade.php para listagem dos dados
    ...
    {
        //chama a view admin/status/create.blade.php com o formulário para cadastro
    ...
    public function show($id)
    {
        ...
        //chama a view admin/status/show.blade.php e passa os dados na variável $data
    ...
    public function update(StoreUpdateStatusFormRequest $request, $id)
    {
        ...
        //redireciona para a view admin/status/index.blade.php
    ...
    {
        //verifica se a conta foi deletada com sucesso e redireciona para a view admin/status/index.blade.php,
    ...
    public function search(Request $request) 
    {
        ...
        //chama a view admin/status/index.blade.php retornado os filtros e os dados encontrados
