...
use App\Http\Requests\StoreUpdateOrigemFormRequest;
...
class OrigemController extends Controller
{
    ...
    public function __construct(OrigemRepositoryInterface $repository, Request $request) 
    {
    ...
    public function index()
    {
        ...
        //chama a view admin/origens/index.blade.php para listagem dos dados
    ...
    {
        //chama a view admin/origens/create.blade.php com o formulário para cadastro
     ...
     * @return \Illuminate\Http\Response
     */
    public function store(StoreUpdateOrigemFormRequest $request)
    {
    ...
    public function show($id)
    {
        ...
        //chama a view admin/origens/show.blade.php e passa os dados na variável $data
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(StoreUpdateOrigemFormRequest $request, $id)
    {
        //atualia os dados de um registro específico
        $this->repository->update($id, $request->all());
        
        //redireciona para a view admin/origens/index.blade.php
    ...
    {
        //verifica se a conta foi deletada com sucesso e redireciona para a view admin/origens/index.blade.php,
    ...
    public function search(Request $request) 
    {
        ...
        //chama a view admin/origens/index.blade.php retornado os filtros e os dados encontrados
