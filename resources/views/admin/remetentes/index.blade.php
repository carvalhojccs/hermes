    ...
    <div class="box box-primary">
        <div class="box-body">
            {{ Form::open(['route' => request()->segment(2).'.search','class' => 'form form-inline']) }}
                {{ Form::text('descricao',$filters['descricao'] ?? '',['placeholder' => 'Nome do remetente','class' => 'form-control']) }}
                {{ Form::text('sigla',$filters['sigla'] ?? '',['placeholder' => 'Código do remetente','class' => 'form-control']) }}
